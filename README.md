# Welcome to My Cybersecurity & IT Infrastructure Portfolio

Hi, I'm Joseph. I am an Information Security graduate specializing in Cybersecurity, Systems Administration, and IT Support Operations. Below is a curated directory of hands-on technical labs demonstrating my capabilities in virtualization, ticketing automation, script coding, and vulnerability assessments.

---

## 🛠️ Core Practical Technical Labs

### 1. [Network Infrastructure Reconnaissance & Vulnerability Assessment](https://github.com/jahmedotori/network-vulnerability-assessment)
*   **Core Focus:** Network mapping, CVE analysis, and server security hardening.
...
### 3. [ARM64 Linux Virtualization & Infrastructure Telemetry Lab](https://github.com/jahmedotori/kali-linux-utm-deployment)
*   **Core Focus:** Low-level hypervisor management, GRUB hacking, and telemetry auditing.
...
*   **Security & Analysis:** Threat Detection, Log Auditing, Incident Triage, Vulnerability Profiling.
*   **Systems & Virtualization:** Linux Administration (CLI), Windows Desktop Support, UTM Hypervisors.
*   **Networking:** TCP/IP Diagnostics (`ping`, `traceroute`, `nslookup`), DNS/DHCP, Port/Socket Auditing.
*   **Automation & Tools:** Python Scripting, Zoho Desk, Freshdesk, Git/GitHub Code Deployment.

📬 **Connect with me on LinkedIn:** [://linkedin.com](www.linkedin.com/in/jahmedotori)
